...
import { Trophy, Star, BookOpen, MessageCircle } from "lucide-react";
...
const AdminRanking = () => {
  ...
  return (
    <AdminLayout title="Ranking de Instrutores">
      {/* pódio (top 3) */}
      {ranked.length >= 3 && (
        <div className="mb-6 flex items-end justify-center gap-2 pt-2">
          {/* 2º */}
        ...
        {ranked.map((inst, idx) => (
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="mt-0.5 text-[10px] text-primary font-semibold">
                {Math.round(inst.score)} pts
              </p>
            </div>
