      ...
      <DialogContent className="border-border bg-background sm:max-w-sm">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-3 pt-1">
          ...
          <DialogFooter className="pt-1">
            <button type="button" onClick={onClose} className="rounded-full btn-press border border-border px-4 py-2 text-xs font-medium text-muted-foreground">
              Cancelar
            </button>
            <button type="submit" disabled={updateUser.isPending} className="rounded-full btn-press bg-primary px-4 py-2 text-xs font-medium text-primary-foreground disabled:opacity-50">
      ...
      <DialogContent className="border-border bg-background sm:max-w-sm">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-3 pt-1">
          ...
          <DialogFooter className="pt-1">
            ...
            <button type="submit" className="rounded-full btn-press bg-primary px-4 py-2 text-xs font-medium text-primary-foreground">
              Enviar
            </button>
          </DialogFooter>
        </form>
      ...
      <DialogContent className="max-h-[85vh] overflow-y-auto border-border bg-background sm:max-w-sm">
        ...
        <DialogFooter className="pt-2">
          ...
          <button
            ...
            className="rounded-full btn-press bg-primary px-4 py-2 text-xs font-medium text-primary-foreground disabled:opacity-40"
          >
